...
export const UNIT_LIST: { "name": string; "member": string[] }[] = [
	...
	{ "name": "メリー", "member": ["美希", "雪歩", "伊織", "あずさ", "春香", "千早", "美希", "やよい", "真"] },
	...
	{ "name": "プリンセススターズ", "member": ["未来", "まつり", "百合子", "可奈", "エミリー"] },
	{ "name": "フェアリースターズ", "member": ["静香", "紬", "恵美", "ジュリア", "志保"] },
	{ "name": "エンジェルスターズ", "member": ["翼", "歌織", "麗花", "杏奈", "星梨花"] },
	{ "name": "Sunshine Rhythm", "member": ["エレナ", "可奈", "翼", "ひなた", "美奈子"] },
	{ "name": "BlueMoon Harmony", "member": ["歩", "紗代子", "朋花", "麗花", "静香"] },
	{ "name": "Starlight Melody", "member": ["亜利沙", "未来", "星梨花", "琴葉", "風花"] },
	{ "name": "765 ALL STARS", "member": ["春香", "千早", "美希", "雪歩", "やよい", "真", "伊織", "貴音", "律子", "あずさ", "亜美", "真美", "響"] },
	{ "name": "プリンセススターズ(13人)", "member": ["未来", "琴葉", "美奈子", "まつり", "百合子", "紗代子", "亜利沙", "海美", "育", "エミリー", "可奈", "奈緒", "のり子"] },
	{ "name": "フェアリースターズ(13人)", "member": ["静香", "恵美", "ロコ", "朋花", "志保", "歩", "千鶴", "瑞希", "莉緒", "昴", "桃子", "ジュリア", "紬"] },
	{ "name": "エンジェルスターズ(13人)", "member": ["翼", "エレナ", "星梨花", "茜", "杏奈", "ひなた", "このみ", "環", "風花", "美也", "可憐", "麗花", "歌織"] },
