...
export const UNIT_LIST: { name: string; member: string[] }[] = [
  ...
  {
    name: 'Legend Girls!!',
    member: ['春香', '朋花', '百合子', '星梨花', '静香'],
  },
  { name: 'PRETTY DREAMER', member: ['響', '未来', '風花', '杏奈', '奈緒'] },
  {
    name: 'レジェンドデイズ',
    member: ['響', '律子', '亜美', '伊織', 'やよい'],
  },
  { name: '乙女ストーム！', member: ['未来', '翼', '百合子', '瑞希', '杏奈'] },
  {
    name: 'クレシェンドブルー',
    member: ['静香', '麗花', '志保', '茜', '星梨花'],
  },
  {
    name: 'エターナルハーモニー',
    member: ['千早', 'エミリー', 'ジュリア', 'まつり', '風花'],
  },
  ...
  {
    name: 'ミックスナッツ',
    member: ['このみ', 'ひなた', '美奈子', '育', '真美'],
  },
  { name: 'ミルキーウェイ', member: ['美希', '紗代子', '朋花', '昴', '千鶴'] },
  { name: 'ARRIVE', member: ['可憐', '貴音', 'エレナ', '莉緒', 'ロコ'] },
  {
    name: '創造は始まりの風を連れて',
    member: ['百合子', '朋花', '星梨花', '亜利沙', 'ロコ'],
  },
  { name: '侠気乱舞', member: ['ジュリア', '桃子', '環', 'ひなた', 'のり子'] },
  {
    name: '赤い世界が消える頃',
    member: ['可奈', '美奈子', '可憐', '瑞希', '麗花'],
  },
  {
    name: '閃光☆HANABI団',
    member: ['紗代子', '奈緒', '海美', '美奈子', 'のり子'],
  },
  {
    name: 'ビッグバンズバリボー!!!!!',
    member: ['海美', '恵美', '紗代子', '風花', '奈緒'],
  },
  {
    name: 'オーディナリィ・クローバー',
    member: ['歌織', '静香', '杏奈', '莉緒', '美也'],
  },
  {
    name: 'ジェネシス×ネメシス',
    member: ['紬', '歌織', 'ジュリア', '真', '茜'],
  },
  { name: 'White Vows', member: ['風花', '莉緒', 'このみ', '歌織', '千鶴'] },
  { name: 'Chrono-Lexica', member: ['百合子', '昴', 'ロコ', '杏奈', '瑞希'] },
  {
    name: '(TC 孤島サスペンスホラー)',
    member: ['茜', 'エレナ', '歌織', '千鶴', '志保'],
  },
  {
    name: '(TC 近未来アウトサイダー)',
    member: ['千早', '美希', 'エミリー', '真', '春香'],
  },
  {
    name: '(TC おとぎの国の物語)',
    member: ['星梨花', '桃子', 'まつり', '響', '昴'],
  },
  {
    name: 'Vault That Borderline!(カバー)',
    member: ['翼', 'ジュリア', '百合子', '紗代子', '瑞希'],
  },
  {
    name: '私はアイドル♡(カバー)',
    member: ['瑞希', '恵美', '美也', '桃子', 'まつり'],
  },
  {
    name: 'ファンキーノート',
    member: ['やよい', '響', '伊織', '亜美', '真美'],
  },
